...
struct SwampCurryFunc * swampCurryFuncAllocate(struct SwampDynamicMemory* self, const struct SwampFunc* sourceFunc, const void* parameters, size_t parametersOctetSize);
