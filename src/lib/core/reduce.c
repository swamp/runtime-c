...
const struct swamp_value* swamp_reducer_reduce_internal_single_fn_helper(swamp_allocator* allocator,
...
const struct swamp_value* swamp_reducer_reduce_internal_single_fn(swamp_allocator* allocator,
                                                                  const swamp_value** arguments, int argument_count,
                                                                  swamp_c_fn_reducer_work_check single_check,
                                                                  const char* debug)
{
    const swamp_value* a = swamp_reducer_reduce_internal_single_fn_helper(allocator, arguments, argument_count,
                                                                          single_check, debug);
...
const struct swamp_value* swamp_reducer_reduce_internal_stop_single_fn(swamp_allocator* allocator,
                                                                       const swamp_value** arguments,
