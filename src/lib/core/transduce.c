...
const struct swamp_value* swamp_transduce_internal(swamp_allocator* allocator, swamp_transducer_stepper stepper,
												   const swamp_function* predicate_fn_object, const swamp_list* sequence,
												   int insert_index)
{
...
const struct swamp_value* swamp_transduce_internal_cast(struct swamp_allocator* allocator, swamp_transducer_stepper stepper,
														swamp_bool insert_index, const struct swamp_value** arguments,
														int argument_count)
{
